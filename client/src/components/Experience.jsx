        ...
        <div name='experience' className='bg-gradient-to-b from-gray-800 to-black w-full h-screen'>
            <div className='max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full text-white'>
                <div>
                    ...
                    <p className='py-6'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Harum quis nesciunt earum accusamus reprehenderit minus assumenda ipsum praesentium suscipit consequatur incidunt blanditiis ducimus, voluptatibus voluptates sint omnis saepe atque necessitatibus.</p>
                </div>

                <div className='w-full grid grid-cols-2 sm:grid-cols-3 text-center gap-8 py-8 px-12 sm:px-0'>
                    {
                        experiences?.map((item) => (
                            <div key={item.key} className={`shadow-md hover:scale-105 duration-500 py-2 rounded-lg ${item.style}`}>
